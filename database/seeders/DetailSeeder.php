...
class DetailSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $dataAgh = [
            ...
            [
                'id' => '154',
                'name' => 'Рабочие колеса (осевая ступень)',
            ],
            [
                'id' => '155',
                'name' => 'Направляющие аппараты (осевая ступень)',
            ],
            [
                'id' => '156',
                'name' => 'Проставок (осевая ступень)',
            ],
            [
                'id' => '157',
                'name' => 'Рабочие колеса (диспергирующая ступень, лабиринтная)',
            ],
            [
                'id' => '158',
                'name' => 'Направляющие аппараты (диспергирующая ступень, лабиринтная)',
            ],
            [
                'id' => '159',
                'name' => 'Втулка защитная вала',
            ...
            [
                'id' => '163',
                'name' => 'Концевые детали: Приемная сетка',
            ],
            [
                'id' => '164',
                'name' => 'Концевые детали: верхний подшипник',
            ...
            [
                'id' => '166',
                'name' => 'Подшипники (втулка защитная)',
            ],
        ];
        ...
        // Детали ГСН
        $dataAgh = array_map(function ($item) {
            $item['unit'] = 'Agh';
            return $item;
        }, $dataAgh);

        foreach ($dataAgh as $item) {
            Detail::create($item);
        }
    }
}
